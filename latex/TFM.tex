...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.90\textwidth]{tandemdiagrama.eps}	%TBD:poner detectores
...
To measure $\gamma$-rays, we use two LaBr\textsubscript{3} (lanthanum bromide) detectors, which we refer to as LaBr\textsubscrip{3}(1) and LaBr\textsubscrip{3}(2).
...
\begin{figure}[H]
	...
	\caption{LaBr\textsubscrip{3}(1) response to \Na source. In red is the fitting of the \qty{511}{\keV} peak to a Gaussian plus a linear background.}
...
\begin{figure}[H]
	...
	\caption{LaBr\textsubscrip{3}(1) response to \textsuperscript{137}Cs source.}
...
\begin{figure}[H]
	...
	\caption{LaBr\textsubscrip{3}(1) response to \textsuperscript{60}Co source.}
...
MONSTER's response to photons is different than the LaBr\textsubscrip{3} detectors.
...
Then, we can compare our results with previous experiments published in the EXFOR database.	%TBD:añadir referencia
...
The Thick Target Yield (TTY) obtained experimentally in this work have been compared with the results from XXXXX et al. [referencia], extracted from the EXFOR database. %TBD: añadir referencia
...
\begin{figure}[H]
	...
	\caption{Final results for thick target yield, next to the data from XXX et.al and a scaled up version.}	%TBD:poner referencia
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.80\textwidth]{activation_result_diffs.eps}	%TBD: cambiar eje y a TTY (This work/XXXX et al.)
	\caption{Ratio of TTY values from this work and from XXXX et al. as a function of the beam energy.}	%TBD:añadir nombre referencia
...
Detectors agree with eachother within \qty{8}{\percent} for April and within \qty{4}{\percent} for February, with one detector (LaBr\textsubscrip{3}(1) and LaBr\textsubscrip{3}(2), respectively) being consistently higher than the other.
...
\begin{thebibliography}{5}
	...
	\bibitem{astro1}The \textit{s} process: Nuclear physics, stellar models, and observations, F. Käppeler et al., Rev. Mod. Phys. 83, 157 – 193 (2011), \url{https://doi.org/10.1103/RevModPhys.83.157}
	\bibitem{astro2}Theoretical uncertainty of \an reactions relevant for the nucleosynthesis of light r-process nuclei in neutrino-driven winds, J. Pereira and F. Montes, Phys. Rev. C 93, 034611 (2016), \url{https://doi.org/10.1103/PhysRevC.93.034611}
	\bibitem{neutron_in_an}Neutron production in \an reactions, \url{https://doi.org/10.1016/j.nima.2020.164095}
	\bibitem{MANY}miniBELEN: A modular neutron counter for \an reactions, N. Mont-Geli et al., EPJ Web of Conf., 284 (2023) 06004, \url{https://doi.org/10.1051/epjconf/202328406004}
%	\bibitem{}\url{https://doi.org/10.1016/j.nima.2009.04.032}
	...
	\bibitem{CAEN}751 Digitizer Family, CAEN, \url{https://www.caen.it/subfamilies/751-digitizer-family/}
