...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{overview_photo.jpg}
...
For the time of flight measurements, the beam is operated in pulsed mode.	%TBD: especificar anchura, frecuencia.
·We time the pulses by using a signal from the chopper/buncher.\\	%TBD:chopper o buncher?
Signal timestamps are registered in relation
